(function(root, factory) {
    ...
    $.fn.maphilight = function(opts) {
        ...
        return this.each(function() {
            ...
            img = $(this);
            $(img).attr('data-wfstyle',$(img).attr('style') || '');
            ...
            wrap = $('<div class="maphl"></div>').css({
                display:'block',
                backgroundImage:'url("'+this.src+'")',
                backgroundSize:'contain',
                position: img.css('position') === 'static' ? 'relative' : img.css('position'),
                padding:0,
                width:this.width,
                height:this.height
            });
            ...
            wrap.attr('style', (wrap.attr('style') + img.attr('data-wfstyle')))
